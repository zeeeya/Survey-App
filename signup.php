...
<html lang="en">
    ...
    <header class="masthead">
      ...
      <h2 class="text-center">Signup</h2>
        ...
        <div class="container" style="width: 5in">
          <form action="php/cust_signup.php" method="post">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                      <select class="form-control input-sm" id="country" style="color: gray">
  ...
  <option value="ZW">Zimbabwe</option>
                ...
                <button type="submit" class="btn btn-success btn-lg" id="sendMessageButton" style="cursor: pointer;">Register</button>

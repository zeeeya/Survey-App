      ...
      <h2 class="text-center">Contact Me</h2>
        ...
        <div class="container" style="width: 5in">
          <form role="form">
                ...
                <div class="form-group">
                      <textarea type="text" name="message" id="message" class="form-control input-sm" placeholder="Message"></textarea> 
                    </div>
                 <button type="submit" class="btn btn-success btn-lg" id="sendMessageButton" style="cursor: pointer;">Send</button>
              </form>
        </div>
      </header>
